...
Welcome to Mintlify! This guide will help you create beautiful, user-friendly documentation that converts. Follow the steps below to get started with your docs.

/

The first step to creating world-class documentation is setting up your editing environment.
